                        ...
                        <table id="example" class="display table-responsive" width="100%" cellspacing="0">
                            <thead>
                                <tr>                                 
                                    ...
                                    <th style="text-align: center"><u>
                                            <a class="btn btn-warning" href="adicionarMarca.jsp" >
                            ...
                            <tbody>
                                ...
                                <tr>                                    
                                    ...
                                    <td style="text-align: center">
                                        <a class="btn btn-info" href="ServletMarca?acao=buscar&txtDocumento=<%=registro.getId_marca()%>" >
                                            <span class="glyphicon glyphicon-edit"></span> Alterar</a></td>  

                                    <!-- BOTÃO EXLUIR -->
                                    <td style="text-align: center">
                                        <a class="btn btn-danger" href="ServletMarca?acao=excluir&txtDocumento=<%=registro.getId_marca()%>" >
