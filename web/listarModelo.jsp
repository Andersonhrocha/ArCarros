                        ...
                        <table id="example" class="display table-responsive" width="100%" cellspacing="0">
                            <thead>
                                <tr>                                 
                                    ...
                                    <th style="text-align: center"><u>
                                            <a class="btn btn-warning" href="adicionarModelo.jsp" >
                            ...
                            <tbody>
                                ...
                                <tr>                                    
                                    ...
                                    <td style="text-align: center"> <%=registro.getMarca().getNome_marca()%> </td>

                                    <!-- BOTÃO EDITAR -->
                                    <td style="text-align: center">
                                        <a class="btn btn-info" href="ServletModelo?acao=buscar&txtDocumento=<%=registro.getId_modelo()%>" >
                                            <span class="glyphicon glyphicon-edit"></span> Alterar</a></td>  

                                    <!-- BOTÃO EXLUIR -->
                                    <td style="text-align: center">
                                        <a class="btn btn-danger" href="ServletModelo?acao=excluir&txtDocumento=<%=registro.getId_modelo()%>" >
