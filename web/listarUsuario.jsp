        ...
        <div id="m_main">           
            ...
            <div id="m_body">
                <div id="container" style="margin:auto; width: 80%">
                    ...
                    <h1 class="titulo">Consulta dos Usuários do Sistema</h1>
                        ...
                        <table id="example" class="display table-responsive" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center"><u>
                                            <a class="btn btn-warning" href="adicionarUsuario.jsp" >
                            ...
                            <tbody>
                                ...
                                <tr>                                    
                                    ...
                                    <td style="text-align: center">                                        
                                        <a class="btn btn-info" href="ServletUsuario?acao=buscar&txtDocumento=<%=registro.getId_usuario()%>" >
                                            <span class="glyphicon glyphicon-edit"></span> Alterar</a></td>  

                                    <!-- BOTÃO EXLUIR -->
                                    <td style="text-align: center">
                                        <a class="btn btn-danger" href="ServletUsuario?acao=excluir&txtDocumento=<%=registro.getId_usuario()%>" >
