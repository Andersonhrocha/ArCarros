...
public class ServletUsuario extends ServletAbstrato {
    ...
    private static final String ADICIONAR_CLIENTE = "adicionarUsuario.jsp";
    private static final String EDITAR_CLIENTE = "editarUsuario.jsp";
    private static final String LISTAR_CLIENTE = "listarUsuario.jsp";
